...
interface StakedTokenInterface extends ethers.utils.Interface {
  functions: {
    "COOLDOWN_DAYS()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "COOLDOWN_DAYS",
    values?: void
  ): string;
  encodeFunctionData(
...
export class StakedToken extends Contract {
  ...
  COOLDOWN_DAYS(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  estimateGas: {
    COOLDOWN_DAYS(): Promise<BigNumber>;
  ...
  populateTransaction: {
    COOLDOWN_DAYS(): Promise<PopulatedTransaction>;
