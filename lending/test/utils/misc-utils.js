...
exports.writeObjectToFile = function (path, obj) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            fs_1.promises.writeFile(path, JSON.stringify(obj)),
          ];
        case 1:
...
exports.writeTextToFile = function (path, text) {
  return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, fs_1.promises.writeFile(path, text)];
        case 1:
          return [2 /*return*/, _a.sent()];
      }
    });
...
exports.getEthereumNetworkFromScriptArgs = function () {
  return process.argv[
    process.argv.findIndex(function (value) {
      return value === "--network";
    }) + 1
  ];
};
exports.convertToCurrencyDecimals = function (currency, amount) {
  return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            ...
            truffle_core_utils_1.getTruffleContractInstance(
              artifacts,
              types_1.ContractId.ERC20Detailed,
              currency
            ),
          ];
        case 1:
        ...
        case 2:
          ...
          amountInCurrencyDecimals = new bignumber_js_1.default(
            amount
          ).multipliedBy(currencyUnit);
          return [2 /*return*/, amountInCurrencyDecimals.toFixed()];
      }
    });
  });
};
exports.convertToCurrencyUnits = function (currency, amount) {
  return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          decimals = _a.sent();
          currencyUnit = new bignumber_js_1.default(10).pow(decimals);
          amountInCurrencyUnits = new bignumber_js_1.default(amount).div(
            currencyUnit
          );
