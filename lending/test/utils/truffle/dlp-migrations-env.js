...
var DlpMigrationsEnv = /** @class */ (function (_super) {
  ...
  function DlpMigrationsEnv(artifacts) {
    ...
    _this._setupMigrationEnv = function (deployer, network, introMessage) {
    ...
    _this._registerAllContractsAddressesInJson = function (network) {
      return function () {
        return __awaiter(_this, void 0, void 0, function () {
          ...
          return __generator(this, function (_c) {
            switch (_c.label) {
              case 0:
                _b = (_a = this.contractsInstancesProvider)
                  .getAllAddressesFromInstances;
                return [
                  4 /*yield*/,
                  this.contractsInstancesProvider.getCurrentDeployedInstancesFromArtifacts(
                    network
                  ),
                ];
              case 1:
                return [
                  4 /*yield*/,
                  _b.apply(_a, [_c.sent().deployedInstances]),
                ];
              case 2:
                ...
                return [
                  4 /*yield*/,
                  misc_utils_1.writeObjectToFile(
                    contractsAddressesFilePath,
                    addressesDeployedContracts
                  ),
                ];
              case 3:
                // Persistence in a json file of the addresses of contracts deployed by other contracts
    ...
    _this.getMigrationHandler = function (migrationMessage, migrationExecutor) {
      return function (deployer, network, accounts) {
        return __awaiter(_this, void 0, void 0, function () {
          var executorParams;
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [
                  4 /*yield*/,
                  this._setupMigrationEnv(deployer, network, migrationMessage),
                ];
              case 1:
                _a.sent();
                executorParams = __assign(
                  {},
                  this.contractsInstancesProvider.getAllGetters(),
                  this.contractsDeploymentsProvider.getAllDeploymentFunctions(
                    deployer
                  ),
                  this.contractsLinkingsProvider.getAllLinkingFunctions(
                    deployer
                  ),
                  this.contractsActionsProvider.getAllActionsFunctions(),
                  this.contractGettersByNetwork.getAllGettersByNetwork(
                    network,
                    accounts
                  ),
                  {
                    registerAllContractsAddressesInJson: this._registerAllContractsAddressesInJson(
                      network
                    ),
...
exports.migrationHandler = function (
  migrationMessage,
  artifacts,
  migrationExecutor
) {
  return new DlpMigrationsEnv(artifacts).getMigrationHandler(
    migrationMessage,
    migrationExecutor
  );
};
