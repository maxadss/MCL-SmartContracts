...
var ContractsGettersByNetwork = /** @class */ (function () {
  function ContractsGettersByNetwork(artifacts) {
    ...
    this._getParamPerNetwork = function (
      network,
      devGetter,
      kovanGetter,
      prodGetter
            ...
            case 0:
              ...
              switch (_a) {
                case types_1.EthereumNetwork.development:
                  return [3 /*break*/, 1];
                case types_1.EthereumNetwork.coverage:
                  return [3 /*break*/, 1];
    ...
    this._getTokenAddresses = function (network) {
      return function () {
        return __awaiter(_this, void 0, void 0, function () {
    ...
    this._getDevReservesAddresses = function () {
      return __awaiter(_this, void 0, void 0, function () {
    ...
    this._getKovanReservesAddresses = function () {
      return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          return [
            2 /*return*/,
    ...
    this._getAllTokenInstances = function (network) {
      return function () {
        return __awaiter(_this, void 0, void 0, function () {
          var allTokenAddresses,
            tokenInstances,
            _i,
            _a,
            _b,
          ...
          return __generator(this, function (_c) {
            switch (_c.label) {
              case 0:
                return [4 /*yield*/, this._getTokenAddresses(network)];
              case 1:
              ...
              case 3:
                ...
                return [
                  ...
                  truffle_core_utils_1.getTruffleContractInstance(
                    this.artifacts,
                    types_1.ContractId.MintableERC20,
                    tokenAddress
                  ),
                ];
              case 4:
    ...
    this._getEthereumAddress = function (network) {
      return function () {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [4 /*yield*/, this._getTokenAddresses(network)()];
              case 1:
                return [2 /*return*/, _a.sent().ETH];
            }
          });
        });
      };
    };
    this._getBlocksPerYear = function (network) {
      return function () {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [
                  ...
                  this._getParamPerNetwork(
                    network,
                    this._getBlocksPerYearDev,
                    this._getBlocksPerYearKovan,
                    // TODO: prod
    ...
    this._getETHUSDPrice = function (network) {
      return function () {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [
                  ...
                  this._getParamPerNetwork(
                    network,
                    this._getEthUSDPriceDev,
                    this._getEthUSDPriceKovan,
                    // TODO: prod
    ...
    this._getReservesParams = function (network) {
      return function () {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    this._getInitialATokenExchangeRateKovan = function () {
      return new bignumber_js_1.default(100)
        .multipliedBy(constants_1.oneRay)
        .toFixed();
    };
    this._getReservesParamsDev = function () {
      return {
        DAI: {
          baseVariableBorrowRate: new bignumber_js_1.default(0.06)
            .multipliedBy(constants_1.oneRay)
            .toFixed(),
          variableBorrowRateScaling: new bignumber_js_1.default(0.25)
            .multipliedBy(constants_1.oneRay)
            .toFixed(),
          fixedBorrowRateScaling: new bignumber_js_1.default(0.1)
            .multipliedBy(constants_1.oneRay)
            .toFixed(),
          borrowToLiquidityRateDelta: new bignumber_js_1.default(0.1)
            .multipliedBy(constants_1.oneRay)
            .toFixed(),
          ...
          reserveDecimals: "18",
          initialExchangeRate: new bignumber_js_1.default(100)
            .multipliedBy(constants_1.oneRay)
            .toFixed(),
        },
        TUSD: {
          baseVariableBorrowRate: new bignumber_js_1.default(0.03)
            .multipliedBy(constants_1.oneRay)
            .toFixed(),
          variableBorrowRateScaling: new bignumber_js_1.default(0.25)
            .multipliedBy(constants_1.oneRay)
        ...
        USDC: {
          baseVariableBorrowRate: new bignumber_js_1.default(0.03)
            .multipliedBy(constants_1.oneRay)
            .toFixed(),
          variableBorrowRateScaling: new bignumber_js_1.default(0.3)
            .multipliedBy(constants_1.oneRay)
            .toFixed(),
          fixedBorrowRateScaling: new bignumber_js_1.default(0.1)
            .multipliedBy(constants_1.oneRay)
        ...
        LEND: {
          baseVariableBorrowRate: new bignumber_js_1.default(0.01)
            .multipliedBy(constants_1.oneRay)
            .toFixed(),
          variableBorrowRateScaling: new bignumber_js_1.default(0.15)
            .multipliedBy(constants_1.oneRay)
            .toFixed(),
          fixedBorrowRateScaling: new bignumber_js_1.default(0.05)
            .multipliedBy(constants_1.oneRay)
            .toFixed(),
          borrowToLiquidityRateDelta: new bignumber_js_1.default(0.1)
            .multipliedBy(constants_1.oneRay)
    ...
    this._getReservesParamsKovan = function () {
      return {
        DAI: {
          baseVariableBorrowRate: new bignumber_js_1.default(0.06)
            .multipliedBy(constants_1.oneRay)
    ...
    this._getInitialAssetPricesDev = function () {
      return {
    ...
    this._getInitialAssetPricesKovan = function () {
      return {
        ETH: constants_1.oneEther.toFixed(),
        DAI: constants_1.oneEther.multipliedBy("0.00369068412860").toFixed(),
        TUSD: constants_1.oneEther.multipliedBy("0.00364714136416").toFixed(),
    ...
    this._getInitialAssetsPrices = function (network) {
      return function () {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [
                  ...
                  this._getParamPerNetwork(
                    network,
                    this._getInitialAssetPricesDev,
    ...
    this._getMarketRatesPerAssetDev = function () {
      return {
        ETH: {
    ...
    this._getMarketRatesPerAssetKovan = function () {
      return {
        ETH: {
          borrowRate: constants_1.oneRay.multipliedBy(0.06).toFixed(),
          liquidityRate: constants_1.oneRay.multipliedBy(0.01).toFixed(),
    ...
    this._getMarketRatesPerAsset = function (network) {
      return function () {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [
                  ...
                  this._getParamPerNetwork(
                    network,
                    this._getMarketRatesPerAssetDev,
    ...
    this._getGenesisLendingPoolManagerAddress = function (network, accounts) {
      return function () {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [
                  ...
                  this._getParamPerNetwork(
                    network,
                    this._getGenesisLendingPoolManagerAddressDev(accounts),
    ...
    this._getGenesisLendingPoolManagerAddressDev = function (accounts) {
      return function () {
        return accounts[0];
      };
    };
    this._getGenesisLendingPoolManagerAddressKovan = function (accounts) {
      return function () {
        return accounts[0];
      };
    };
    this._getFirstDepositorAddressOnTests = function (network, accounts) {
      return function () {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [
                  ...
                  this._getParamPerNetwork(
                    network,
                    this._getFirstDepositorAddressOnTestsDev(accounts),
    ...
    this._getFirstDepositorAddressOnTestsDev = function (accounts) {
      return function () {
        return accounts[0];
      };
    };
    this._getFirstDepositorAddressOnTestsKovan = function (accounts) {
      return function () {
        return accounts[0];
      };
    };
    this._getFirstBorrowerAddressOnTests = function (network, accounts) {
      return function () {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [
                  ...
                  this._getParamPerNetwork(
                    network,
                    this._getFirstBorrowerAddressOnTestsDev(accounts),
    ...
    this._getFirstBorrowerAddressOnTestsDev = function (accounts) {
      return function () {
        return accounts[1];
      };
    };
    this._getFirstBorrowerAddressOnTestsKovan = function (accounts) {
      return function () {
        return accounts[1];
      };
    };
    this._getWeb3 = function (network) {
      return function () {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    this._getWeb3Dev = function () {
      return new web3_1.default(
        misc_utils_1.getHttpProviderUrlByNetwork(
          types_1.EthereumNetwork.development
        )
      );
    };
    this._getWeb3Kovan = function () {
      return new web3_1.default(
        misc_utils_1.getHttpProviderUrlByNetwork(types_1.EthereumNetwork.kovan)
      );
    };
    this._getGenesisFeeCollectionAddress = function (network, accounts) {
      return function () {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [
                  ...
                  this._getParamPerNetwork(
                    network,
                    this._getGenesisFeeCollectionAddressDev(accounts),
    ...
    this._getGenesisFeeCollectionAddressDev = function (accounts) {
      return function () {
        return accounts[0];
      };
    };
    ...
    this._getBlocksPerYearDev = function () {
      return 21600;
    };
    this._getBlocksPerYearKovan = function () {
      return 21600;
    };
    this._getBlocksPerYearProd = function () {
      return 21600;
    };
    this._getEthUSDPriceDev = function () {
      return constants_1.oneEther.multipliedBy(250).toFixed();
    }; // 250 USD
    this._getEthUSDPriceKovan = function () {
      return constants_1.oneEther.multipliedBy(250).toFixed();
    }; // 250 USD
    this._getEthUSDPriceProd = function () {
      return constants_1.oneEther.multipliedBy(250).toFixed();
    }; // 250 USD
    this.getAllGettersByNetwork = function (network, accounts) {
      return {
        ...
        getGenesisFeeCollectionAddress: _this._getGenesisFeeCollectionAddress(
          network,
          accounts
        ),
        getGenesisLendingPoolManagerAddress: _this._getGenesisLendingPoolManagerAddress(
          network,
          accounts
        ),
        getFirstBorrowerAddressOnTests: _this._getFirstBorrowerAddressOnTests(
          network,
          accounts
        ),
        getFirstDepositorAddressOnTests: _this._getFirstDepositorAddressOnTests(
          network,
          accounts
        ),
