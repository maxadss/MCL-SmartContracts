...
var ContractsDeploymentsProvider = /** @class */ (function () {
  function ContractsDeploymentsProvider(artifacts) {
    ...
    this.deployContract = function (deployer, contractId, args) {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                truffle_core_utils_1.deployContractTruffle(
                  this.artifacts,
                  deployer,
                  contractId,
                  args
          ...
          return __generator(this, function (_b) {
            switch (_b.label) {
              ...
              case 1:
                ...
                return [
                  4 /*yield*/,
                  this.deployContract(deployer, mockTokenContractName),
                ];
              case 2:
                _b.sent();
                _b.label = 3;
            ...
            switch (_a.label) {
              case 0:
                return [
                  ...
                  this.deployContract(
                    deployer,
                    types_1.ContractId.LendingPoolParametersProvider,
                    args
                  ),
                ];
              case 1:
            ...
            switch (_a.label) {
              case 0:
                return [
                  ...
                  this.deployContract(
                    deployer,
                    types_1.ContractId.LendingPoolLiquidationManager,
                    args
                  ),
                ];
              case 1:
    ...
    this.getAllDeploymentFunctions = function (deployer) {
      return {
        deployMigrationsContract: _this._deployMigrationsContract(deployer),
        deployAllMockTokens: _this._deployAllMockTokens(deployer),
        deployMockFlashLoanReceiver: _this._deployMockFlashLoanReceiver(
          deployer
        ),
        deployLendingPoolAddressesProvider: _this._deployLendingPoolAddressesProvider(
          deployer
        ),
        deployLendingPoolParametersProviderContract: _this._deployLendingPoolParametersProvider(
          deployer
        ),
        deployFeeProviderContract: _this._deployFeeProviderContract(deployer),
        deployNetworkMetadataProviderContract: _this._deployNetworkMetadataProviderContract(
          deployer
        ),
        deployPriceOracleContract: _this._deployPriceOracleContract(deployer),
        deployLendingRateOracleContract: _this._deployLendingRateOracleContract(
          deployer
        ),
        deployCoreLibraryLibrary: _this._deployCoreLibraryLibrary(deployer),
        deployLendingPoolCoreContract: _this._deployLendingPoolCoreContract(
          deployer
        ),
        deployLendingPoolConfiguratorContract: _this._deployLendingPoolConfiguratorContract(
          deployer
        ),
        deployLendingPoolDataProviderContract: _this._deployLendingPoolDataProviderContract(
          deployer
        ),
        deployLendingPoolContract: _this._deployLendingPoolContract(deployer),
        deployLendingPoolLiquidationManager: _this._deployLendingPoolLiquidationManager(
          deployer
        ),
        deployWalletBalanceProvider: _this._deployWalletBalanceProvider(
          deployer
        ),
      };
    };
