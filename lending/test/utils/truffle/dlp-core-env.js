...
var DlpCoreEnv = /** @class */ (function () {
  function DlpCoreEnv(artifacts) {
    ...
    this.contractsDeploymentsProvider = new contracts_deployments_provider_1.ContractsDeploymentsProvider(
      artifacts
    );
    this.contractsLinkingsProvider = new contracts_linkings_provider_1.ContractsLinkingsProvider(
      artifacts
    );
    this.contractsActionsProvider = new contracts_actions_provider_1.ContractsActionsProvider(
      artifacts
    );
