 ...
 * @author Multiplier Finance, influenced by https://github.com/wbobeirne/
 * eth-balance-checker/blob/master/contracts/BalanceChecker.sol
 * @notice Implements a logic of getting multiple tokens balance for one user
 * address
 * @dev NOTE: THIS CONTRACT IS NOT USED WITHIN THE bMXX PROTOCOL. It's an
 * accessory contract used to reduce the number of calls
 * towards the blockchain from the Multiplier backend.
 **/
    ...
    */
        ...
        returns (address[] memory, uint256[] memory)
    {
        ...
        for (uint256 j = 0; j < reserves.length; j++) {
            ...
            if (reserves[j] != BscAddressLib.bnbAddress()) {
