...
contract MockFlashLoanReceiver is FlashLoanReceiverBase {
    ...
    function executeOperation(
        ...
        //execution does not fail - mint tokens and return them to the
        // _destination
        // note: if the reserve is eth, the mock contract must receive at least
        // _fee ETH before calling executeOperation
