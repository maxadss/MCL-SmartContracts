...
interface LendingPoolCoreInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: "CORE_REVISION", values?: void): string;
  encodeFunctionData(
    functionFragment: "addressesProvider",
    values?: void
  ): string;
  encodeFunctionData(functionFragment: "feeProvider", values?: void): string;
  encodeFunctionData(
...
export class LendingPoolCore extends Contract {
  ...
  functions: {
     ...
     * @param _liquidatorReceivesMToken true if the liquidator will receive Tokens, false otherwise*
    ...
    /**
     * gets the underlying asset balance of a user based on the corresponding bMXXToken balance.
     * @param _reserve the reserve address
    ...
    /**
     * gets the mToken contract address for the reserve
     * @param _reserve the reserve address
     * @returns the address of the mToken contract*
     */
  ...
  estimateGas: {
    ...
    initialize(_addresessProvider: string): Promise<BigNumber>;
    updateStateOnDeposit(
      _reserve: string,
      _user: string,
      _amount: BigNumberish,
    ...
    updateStateOnFlashLoan(_reserve: string): Promise<BigNumber>;
    updateStateOnBorrow(
      _reserve: string,
      _user: string,
      _amountBorrowed: BigNumberish,
    ...
    liquidateFee(_token: string, _amount: BigNumberish): Promise<BigNumber>;
    transferToReserve(
      _reserve: string,
      _user: string,
      _amount: BigNumberish
    ...
    getUsermTokenBalance(_reserve: string, _user: string): Promise<BigNumber>;
    getUserStakedTokenBalance(_user: string): Promise<BigNumber>;
    getReserveInterestRateStrategyAddress(_reserve: string): Promise<BigNumber>;
    getReservemTokenAddress(_reserve: string): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    feeProvider(): Promise<PopulatedTransaction>;
    ...
    initialize(_addresessProvider: string): Promise<PopulatedTransaction>;
    updateStateOnDeposit(
      _reserve: string,
      _user: string,
      _amount: BigNumberish,
    ...
    updateStateOnFlashLoan(_reserve: string): Promise<PopulatedTransaction>;
    updateStateOnBorrow(
      _reserve: string,
      _user: string,
      _amountBorrowed: BigNumberish,
    ...
    getUserStakedTokenBalance(_user: string): Promise<PopulatedTransaction>;
    getReserveInterestRateStrategyAddress(
      _reserve: string
    ): Promise<PopulatedTransaction>;
    getReservemTokenAddress(_reserve: string): Promise<PopulatedTransaction>;
    getReserveAvailableLiquidity(
      _reserve: string
    ): Promise<PopulatedTransaction>;
